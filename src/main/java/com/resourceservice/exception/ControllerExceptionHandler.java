...
public class ControllerExceptionHandler {
    ...
    @ExceptionHandler(ResourceClassNotFoundException.class)
    public ResponseEntity<ErrorMessage> resourceClassNotFoundException(ResourceClassNotFoundException ex, WebRequest request) {
